  ...
  return (
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-10">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-7xl md:text-9xl font-black tracking-tighter leading-none mb-8">
            The <span className="text-foreground/20 italic underline decoration-primary decoration-4 underline-offset-8">Collective</span>
          </motion.h1>
          <motion.p variants={itemVariants} className="text-2xl text-muted-foreground font-medium max-w-2xl mx-auto italic leading-relaxed">
            "Connect with engineering veterans who have scaled the most influential open-source infrastructure on the planet."
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <h2 className="text-4xl font-black mb-6 tracking-tight">Join as an <span className="text-primary italic">Expert</span></h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 font-medium">
            Have you successfully scaled major open-source projects? Help the next generation of contributors scale their impact.
          </p>
          <Link href="mailto:mission@openveda.in" className="bg-muted border border-border hover:bg-foreground hover:text-background font-black px-12 py-5 rounded-[2rem] text-xs uppercase tracking-widest transition-all">
            Join the Collective
          </Link>
        </motion.div>
      </div>
      ...
      <footer className="mt-40 py-20 border-t border-border text-center">
        ...
        <p className="text-xs text-muted-foreground font-bold tracking-widest">© {new Date().getFullYear()} • BUILT FOR IMPACT</p>
      </footer>
    </main>
  );
}
