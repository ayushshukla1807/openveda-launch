      ...
      >
        ...
        <div className="space-y-12">
          <motion.div variants={itemVariants} className="text-center md:text-left space-y-2">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white italic">Founding Architect</h2>
            <p className="text-sm text-gray-400 max-w-xl">
              Meet the mind driving the year-round contribution engine and building elite systems portfolios.
            </p>
          </motion.div>

          <motion.div 
            variants={itemVariants} 
            className="grid grid-cols-1 max-w-2xl gap-8"
          >
            {/* Ayush Shukla */}
