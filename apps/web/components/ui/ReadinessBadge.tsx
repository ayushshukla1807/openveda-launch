    ...
    >
      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        <div className="flex flex-col w-full gap-4">
            <button 
                onClick={() => {
                    const certUrl = `https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=GSoC%202027%20Readiness%20Certified&organizationName=OpenVeda&issueYear=2026&issueMonth=5&certUrl=https://openveda.in/verify/${username}`;
