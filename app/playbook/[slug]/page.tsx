  ...
  return (
    <div className="min-h-screen">
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12"> <h1 className="text-5xl font-bold">{playbook.name}</h1> <p className="mt-2 text-lg text-gray-400">Your OpenVeda Playbook</p> </div>
        <article className="prose prose-invert prose-lg max-w-none prose-a:text-green-400"> <ReactMarkdown>{playbook.content}</ReactMarkdown> </article>
        <div className="mt-16 text-center bg-gray-800 border border-green-500 rounded-lg p-8">
            ...
            <Link href="YOUR_CALENDLY_LINK_HERE" target="_blank" rel="noopener noreferrer" className="mt-6 inline-block bg-green-500 text-white font-bold py-3 px-8 rounded-lg hover:bg-green-600">
